...
if( !function_exists('wpb_wpbean_socail_info') ){
	function wpb_wpbean_socail_info(){
		...
		<div class="wpb_wpbean_socials">
			...
			<a href="https://twitter.com/wpbean" title="<?php esc_html_e( 'Follow us on Twitter', 'wpb_fp' ) ?>" class="wpb_twitter" target="_blank"><?php esc_html_e( 'Follow us on Twitter', 'wpb_fp' ) ?></a>
			<a href="https://www.facebook.com/wpbean" title="<?php esc_html_e( 'Follow us on Facebook', 'wpb_fp' ) ?>" class="wpb_facebook" target="_blank"><?php esc_html_e( 'Follow us on Facebook', 'wpb_fp' ) ?></a>
			<a href="https://www.youtube.com/user/wpbean/videos" title="<?php esc_html_e( 'Follow us on Youtube', 'wpb_fp' ) ?>" class="wpb_youtube" target="_blank"><?php esc_html_e( 'Follow us on Youtube', 'wpb_fp' ) ?></a>
		</div>
		<?php
	}
}
