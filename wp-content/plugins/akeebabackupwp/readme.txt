...
= 3.6.1 =
* Prevent site display and show link to the restoration script when the installation folder is present and contains ANGIE
...
* [MEDIUM] WordPress restoration: blog name and tagline were not updated
