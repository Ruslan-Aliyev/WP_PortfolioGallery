...
<div class="verynsbigboxcontainer">
	<div class="postbox nsproversionfbpx4wp">
        <h3 class="titprofbpx4wp"><?php echo $ns_full_name; ?></h3>
	        ...
	        <h2 class="titlefbpx4wp"><?php _e('How to use', 'ns-frontend-add-product');?></h2><br><br>
	        ...
	        <div class="colprofbpx4wp2">
	        	<div class="ns-container-title-arrow">
		        	<h2 class="titlefbpx4wp ns-hidepremiumfeature"><?php _e('Premium features', 'ns-frontend-add-product');?></h2>
	        	...
	        	<h2 class="titlefbpx4wp2"><?php _e('Go Premium, get more features and support:', 'ns-frontend-add-product'); ?></h2><br><br>
				...
				of additional features of the premium version.', 'ns-frontend-add-product'); ?><br><br>
				<a id="fbp4wplinkpremiumboxpremium" class="button-primary" href="<?php echo $link_bannerone; ?>" target="_blank"><?php _e('Go Premium Now', 'ns-frontend-add-product'); ?></a>
	        </div>
    </div>	

			<div class="icon32" id="icon-options-general"><br /></div>
			<h2><?php echo $ns_full_name; ?> <?php _e('Settings', 'ns-frontend-add-product'); ?></h2>
